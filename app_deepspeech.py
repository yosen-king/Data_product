...
def main():
    st.header("数据管理与产品开发课程设计---hzk/hfq/yjs")
    st.markdown("实时语音转文本")
    st.markdown(
        """
这个APP是使用 [DeepSpeech](https://github.com/mozilla/DeepSpeech),
一个开源的语音转文本引擎.
...
"""
    ...
    sound_only_page = "纯声音识别"
    with_video_page = "有视频"
    app_mode = st.selectbox("选择一个模式", [sound_only_page, with_video_page])
